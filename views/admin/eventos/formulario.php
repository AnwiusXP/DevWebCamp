<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        ...
        <select class="formulario__select" id="categoria" name="categoria_id">
            ...
            <?php foreach ($categorias as $categoria) { ?>
                <option <?php echo ($evento->categoria_id === $categoria->id) ? 'selected' : ''; ?> value="<?php echo $categoria->id; ?>"><?php echo $categoria->nombre; ?>
                </option> <?php } ?>
        </select>
    </div>
    ...
    <div id="horas" class="formulario__campo">
        <label class="formulario__hora">Seleccionar Hora</label>
        <ul class="horas">
