<footer class="footer">
    <div class="footer__grid">
        <div class="footer__contenido">
            ...
            <p class="footer__texto">
                Devwebcamp es una conferencia para los desarrolladores de todos los niveles en presencial y en linea.
            </p>
        </div>
    ...
    <p class="footer__copyright">
        Devwebcamp <span class="footer__copyright--regular">Todo los derechos reservados <?php echo date('Y') ?></span>
    </p>
</footer>