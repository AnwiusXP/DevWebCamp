(() => {
  var e = {
      ...
      379: (e) => {
        ...
        function r(e, r) {
          for (var n = {}, a = [], o = 0; o < e.length; o++) {
            ...
            if (-1 !== u) t[u].references++, t[u].updater(h);
              ...
              var f = s(h, r);
              (r.byIndex = o),
                t.splice(o, 0, { identifier: c, updater: f, references: 1 });
            }
            a.push(c);
          }
          return a;
        ...
        e.exports = function (e, s) {
          ...
          return function (e) {
            ...
            for (var l = r(e, s), d = 0; d < n.length; d++) {
              var p = i(n[d]);
      ...
      352: () => {
        !(function () {
          if (document.querySelector('#horas')) {
            const r = document.querySelector('[name="categoria_id"]'),
              s = document.querySelectorAll('[name="dia"]'),
              n = document.querySelector('[name="dia_id"]'),
              a = document.querySelector('[name="hora_id"]');
            r.addEventListener('change', e),
              s.forEach((t) => t.addEventListener('change', e));
            let o = { categoria_id: r.value || '', dia: n.value || '' };
            function e(e) {
              (o[e.target.name] = e.target.value),
                (a.value = ''),
                (n.value = '');
              const i = document.querySelector('.horas__hora--selected');
              i && i.classList.remove('horas__hora--selected'),
                Object.values(o).includes('') || t();
            }
            async function t() {
              const { dia: e, categoria_id: t } = o,
                r = `/api/eventos-horario?dia_id=${e}&categoria_id=${t}`,
                s = await fetch(r);
              !(function (e) {
                const t = document.querySelectorAll('#horas li');
                t.forEach((e) => e.classList.add('horas__hora--deshabilitada'));
                const r = e.map((e) => e.hora_id);
                Array.from(t)
                  .filter((e) => !r.includes(e.dataset.horaId))
                  .forEach((e) =>
                    e.classList.remove('horas__hora--deshabilitada')
                  ),
                  document
                    .querySelectorAll(
            ...
            function i(e) {
              const t = document.querySelector('.horas__hora--selected');
              t && t.classList.remove('horas__hora--selected'),
                e.target.classList.add('horas__hora--selected'),
                (a.value = e.target.dataset.horaId),
                (n.value = document.querySelector(
                  '[name="dia"]:checked'
                ).value);
            }
            Object.values(o).includes('') ||
              (async () => {
                await t();
                const e = a.value,
                  r = document.querySelector(`[data-hora-id="${e}"]`);
                r.classList.remove('horas__hora--deshabilitada'),
                  r.classList.add('horas__hora--selected'),
                  (r.onclick = i);
              })();
          }
        })();
      ...
      859: () => {
        !(function () {
          const e = document.querySelector('#ponentes');
          if (e) {
            let i = [],
              r = [];
            const s = document.querySelector('#listado-ponentes'),
              n = document.querySelector('[name="ponente_id"]');
            function t(e) {
              const t = e.target,
              ...
              i &&
                i.classList.remove('listado-ponentes__ponente--seleccionado'),
                t.classList.add('listado-ponentes__ponente--seleccionado'),
                (n.value = t.dataset.ponenteId);
            }
            !(async function () {
              const e = await fetch('/api/ponentes');
              !(function (e = []) {
                i = e.map((e) => ({
                  nombre: `${e.nombre.trim()} ${e.apellido.trim()}`,
                  id: '' + e.id,
                }));
              })(await e.json());
            })(),
              e.addEventListener('input', function (e) {
                ...
                if (n.length > 3) {
                  ...
                  r = i.filter((t) => {
                    if (-1 != t.nombre.toLowerCase().search(e)) return t;
                  });
                } else r = [];
                !(function () {
                  ...
                  if (r.length > 0)
                    r.forEach((e) => {
                      ...
                      i.classList.add('listado-ponentes__ponente'),
                        (i.textContent = e.nombre),
                        (i.dataset.ponenteId = e.id),
                        (i.onclick = t),
                        s.appendChild(i);
                    });
                  else {
                    const e = document.createElement('P');
                    e.classList.add('listado-ponentes__no-resultados'),
                      (e.textContent = 'No hay resultados para tu busqueda'),
                      s.appendChild(e);
                  }
                })();
              }),
              n.value &&
                (async () => {
                  ...
                  t.classList.add(
                    ...
                    (t.textContent = `${e.nombre} ${e.apellido}`),
                    s.appendChild(t);
                })();
          }
        })();
      ...
      696: () => {
        !(function () {
          ...
          if (e) {
            const s = document.querySelector('#tags'),
              n = document.querySelector('[name="tags"]');
            let a = [];
            function t() {
              (s.textContent = ''),
                a.forEach((e) => {
                  const t = document.createElement('LI');
                  t.classList.add('formulario__tag'),
                    (t.textContent = e),
                    (t.ondblclick = i),
                    s.appendChild(t);
                }),
            ...
            function i(e) {
              e.target.remove(),
                (a = a.filter((t) => t !== e.target.textContent)),
                r();
            }
            function r() {
              n.value = a.toString();
            }
            '' !== n.value && ((a = n.value.split(',')), t()),
              e.addEventListener('keypress', function (i) {
                if (44 === i.keyCode) {
                  if ('' === i.target.value.trim() || i.target.value < 1)
                    return;
                  i.preventDefault(),
                    (a = [...a, i.target.value.trim()]),
                    (e.value = ''),
                    t();
                }
              });
  ...
  (i.m = e),
    ...
    (() => {
            ...
            for (let i = 0, r = e.length; i < r; i += 1) {
              ...
              void 0 !== s &&
                ...
                (d(t[r]) && d(n[r])
                  ...
                  : !d(t[r]) && d(n[r])
                  ? ((t[r] = {}),
                    n[r].__swiper__ ? (t[r] = n[r]) : p(t[r], n[r]))
                  : (t[r] = n[r]));
            }
          }
        }
      ...
      function u({ swiper: e, targetPosition: t, side: i }) {
        ...
        const d = t > s ? 'next' : 'prev',
          ...
          c = () => {
            ...
            let u = s + d * (t - s);
            if ((p(u, t) && (u = t), e.wrapperEl.scrollTo({ [i]: u }), p(u, t)))
              return (
      ...
      const y = {
        updateSize: function () {
          ...
          (t =
            ...
            (0 === t && e.isHorizontal()) ||
              ...
              ((t =
                t -
                parseInt(f(r, 'padding-left') || 0, 10) -
                parseInt(f(r, 'padding-right') || 0, 10)),
              (i =
                i -
                parseInt(f(r, 'padding-top') || 0, 10) -
                parseInt(f(r, 'padding-bottom') || 0, 10)),
              Number.isNaN(t) && (t = 0),
              Number.isNaN(i) && (i = 0),
              Object.assign(e, {
                width: t,
        ...
        updateSlides: function () {
          ...
          const r = e.params,
            ...
            w = d ? e.virtual.slides.length : u.length;
          let m = [];
          const v = [],
            b = [];
          let A = r.slidesOffsetBefore;
          'function' == typeof A && (A = r.slidesOffsetBefore.call(e));
          ...
          'string' == typeof T &&
            ...
            r.centeredSlides &&
              r.cssMode &&
              (c(s, '--swiper-centered-offset-before', ''),
              c(s, '--swiper-centered-offset-after', ''));
          const k = r.grid && r.grid.rows > 1 && e.grid;
          let P;
          k && e.grid.initSlides(w);
          const z =
          ...
          for (let s = 0; s < w; s += 1) {
            ...
            if (
              ((P = 0),
              u[s] && (n = u[s]),
              k && e.grid.updateSlide(s, n, w, t),
              !u[s] || 'none' !== f(n, 'display'))
            ) {
              if ('auto' === r.slidesPerView) {
                ...
                if (
                  ...
                  P = e.isHorizontal() ? g(n, 'width', !0) : g(n, 'height', !0);
                else {
                  const e = i(a, 'width'),
                    t = i(a, 'padding-left'),
                    r = i(a, 'padding-right'),
                ...
                (P = (a - (r.slidesPerView - 1) * T) / r.slidesPerView),
                  r.roundLengths && (P = Math.floor(P)),
                  u[s] && (u[s].style[t('width')] = P + 'px');
              u[s] && (u[s].swiperSlideSize = P),
                b.push(P),
                r.centeredSlides
                  ? ((E = E + P / 2 + C / 2 + T),
                    0 === C && 0 !== s && (E = E - a / 2 - T),
          ...
          if (
            ...
            o &&
              ...
              (s.style.width = e.virtualSize + r.spaceBetween + 'px'),
            r.setWrapperSize &&
              (s.style[t('width')] = e.virtualSize + r.spaceBetween + 'px'),
          ...
          if (
            ...
            c(s, '--swiper-centered-offset-before', -m[0] + 'px'),
              c(
                s,
        ...
        updateSlidesOffset: function () {
          ...
          for (let r = 0; r < t.length; r += 1)
            t[r].swiperSlideOffset =
              (e.isHorizontal() ? t[r].offsetLeft : t[r].offsetTop) - i;
        },
        ...
        updateSlidesClasses: function () {
          const e = this,
            ...
            a = (e) => h(r, `.${i.slideClass}${e}, swiper-slide${e}`)[0];
          let o;
          if (
            (t.forEach((e) => {
              e.classList.remove(
      ...
      function x({ swiper: e, runCallbacks: t, direction: i, step: r }) {
      ...
      function S(e) {
        ...
        h && c.target && c.target.shadowRoot && f && (u = f[0]);
        const w = o.noSwipingSelector
            ? o.noSwipingSelector
            : '.' + o.noSwipingClass,
        ...
        u.matches(n.focusableElements) &&
          ((y = !1), 'SELECT' === u.nodeName && (n.isTouched = !1)),
          i.activeElement &&
            i.activeElement.matches(n.focusableElements) &&
            i.activeElement !== u &&
            i.activeElement.blur();
        const x = y && t.allowTouchMove && o.touchStartPreventDefault;
      ...
      function T(e) {
        const t = s(),
          i = this,
          r = i.touchEventsData,
          { params: n, touches: a, rtlTranslate: o, enabled: d } = i;
        if (!d) return;
        ...
        if ((p.originalEvent && (p = p.originalEvent), !r.isTouched))
          return void (
            r.startMoving &&
            r.isScrolling &&
            i.emit('touchMoveOpposite', p)
          );
        const c = r.evCache.findIndex((e) => e.pointerId === p.pointerId);
        c >= 0 && (r.evCache[c] = p);
        const u = r.evCache.length > 1 ? r.evCache[0] : p,
          h = u.pageX,
          f = u.pageY;
        ...
        if (!i.allowTouchMove)
          return (
            p.target.matches(r.focusableElements) || (i.allowClick = !1),
            void (
              r.isTouched &&
              (Object.assign(a, {
                startX: h,
        ...
        if (
          (r.allowTouchCallbacks && i.emit('touchMove', p),
        ...
        if (
          i.params.threshold &&
          Math.sqrt(w ** 2 + g ** 2) < i.params.threshold
        )
          return;
        if (void 0 === r.isScrolling) {
          ...
          (i.isVertical() && a.currentX === a.startX)
            ? (r.isScrolling = !1)
            : w * w + g * g >= 25 &&
              ((e = (180 * Math.atan2(Math.abs(g), Math.abs(w))) / Math.PI),
        ...
        const A = i.params.loop && !n.cssMode;
        if (!r.isMoved) {
          if (
            (A && i.loopFix({ direction: i.swipeDirection }),
              ...
              r.currentTranslate > i.minTranslate() &&
                ...
                n.resistance &&
                  (r.currentTranslate =
                    i.minTranslate() -
                    1 +
                    (-i.minTranslate() + r.startTranslate + m) ** S)))
            : m < 0 &&
              (A &&
                !y &&
                r.currentTranslate <
              ...
              r.currentTranslate < i.maxTranslate() &&
                ...
                n.resistance &&
                  (r.currentTranslate =
                    i.maxTranslate() +
                    1 -
                    (i.maxTranslate() - r.startTranslate - m) ** S))),
      ...
      function E(e) {
        ...
        for (
          ...
          void 0 !== d[e + t]
            ? f >= d[e] && f < d[e + t] && ((w = e), (g = d[e + t] - d[e]))
            : f >= d[e] && ((w = e), (g = d[d.length - 1] - d[d.length - 2]));
        }
        let m = null,
          v = null;
        s.rewind &&
          (t.isBeginning
            ...
            : t.isEnd && (m = 0));
        const b = (f - d[w]) / g,
          A = w < s.slidesPerGroupSkip - 1 ? 1 : s.slidesPerGroup;
        if (h > s.longSwipesMs) {
          if (!s.longSwipes) return void t.slideTo(t.activeIndex);
          'next' === t.swipeDirection &&
            (b >= s.longSwipesRatio
              ? t.slideTo(s.rewind && t.isEnd ? m : w + A)
              : t.slideTo(w)),
          ...
          (c.target !== t.navigation.nextEl && c.target !== t.navigation.prevEl)
            ? ('next' === t.swipeDirection && t.slideTo(null !== m ? m : w + A),
              'prev' === t.swipeDirection && t.slideTo(null !== v ? v : w))
          ...
          loop: {
            ...
            loopFix: function ({
              ...
              if (
                ...
                if (w.length > 0 && b)
                  if (void 0 === e) {
                    const e = o.slidesGrid[m],
                      t = o.slidesGrid[m + A] - e;
                    a
            ...
            loopDestroy: function () {
              const e = this,
                { slides: t, params: i, slidesEl: r } = e;
          ...
          events: {
            attachEvents: function () {
              ...
              (e.onTouchStart = S.bind(e)),
                ...
                (e.onClick = k.bind(e)),
                (e.onLoad = L.bind(e)),
                I || (t.addEventListener('touchstart', G), (I = !0)),
                O(e, 'on');
            },
          ...
          breakpoints: {
            setBreakpoint: function () {
              ...
              const u = o.direction && o.direction !== r.direction,
                h = r.loop && (o.slidesPerView !== r.slidesPerView || u);
      ...
      class F {
                ...
                v ||
                  (v = (function ({ userAgent: e } = {}) {
                    ...
                    const c = s.match(/(iPod)(.*OS\s([\d_]+))?/),
                      u = !p && s.match(/(iPhone\sOS|iOS)\s([\d_]+)/),
                      h = 'Win32' === r;
                    let f = 'MacIntel' === r;
                    return (
                      !p &&
        ...
        getSlideIndex(e) {
          const { slidesEl: t, params: i } = this,
            r = w(h(t, `.${i.slideClass}, swiper-slide`)[0]);
          return w(e) - r;
        }
        recalcSlides() {
        ...
        mount(e) {
          ...
          return (
            ...
            Object.assign(t, {
              ...
              mounted: !0,
              rtl: 'rtl' === i.dir.toLowerCase() || 'rtl' === f(i, 'direction'),
              rtlTranslate:
                'horizontal' === t.params.direction &&
                ('rtl' === i.dir.toLowerCase() || 'rtl' === f(i, 'direction')),
              wrongRTL: '-webkit-box' === f(s, 'display'),
            }),
            !0
          );
        }
      ...
      var V = i(379),
        ...
        ee = i(231),
        te = {};
      (te.styleTagTransform = J()),
        (te.setAttributes = Z()),
        (te.insert = X().bind(null, 'head')),
        (te.domAPI = q()),
        (te.insertStyleElement = $()),
        H()(ee.Z, te),
        ee.Z && ee.Z.locals && ee.Z.locals,
        document.addEventListener('DOMContentLoaded', function () {
          document.querySelector('.slider') && new j('.slider', {});
        });
    })();
})();
